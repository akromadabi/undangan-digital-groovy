...
export default function Dashboard({ stats, recentUsers, recentPayments }) {
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-[#999] mt-1.5 flex items-center gap-1">
                                    <Icon d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" className="w-3 h-3" />
                                    user terdaftar
                                </p>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl border border-[#e8e5e0] p-5 hover:shadow-md transition-all group">
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                <p className="text-xs font-semibold text-[#999] uppercase tracking-wider">Undangan Aktif</p>
                                <p className="text-3xl font-bold text-[#1a1a1a] mt-2">{activeInvitations}</p>
                                <p className="text-xs text-[#999] mt-1.5 flex items-center gap-1">
                                    {totalUsers > 0 ? (
                                        <><span className="text-emerald-600 font-semibold">{Math.round((activeInvitations / totalUsers) * 100)}%</span> dari total user</>
                                    ) : 'undangan dibuat'}
                                </p>
                            </div>
                            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                                <Icon d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" className="w-5 h-5 text-white" />
                            </div>
                        </div>
                                ...
                                <p className="text-xs mt-1.5">
                                    {pendingPayments > 0 ? (
                                        <span className="text-amber-600 font-medium inline-flex items-center gap-1">
                                            <Icon d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" className="w-3 h-3" />
                                            perlu diproses
                                        </span>
                                    ) : (
                                        <span className="text-emerald-600 font-medium inline-flex items-center gap-1">
                                            <Icon d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" className="w-3 h-3" />
                                            semua clear
                                        </span>
                                    )}
                                </p>
                            </div>
                            <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${pendingPayments > 0 ? 'from-amber-500 to-amber-600' : 'from-violet-500 to-violet-600'} flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform`}>
