            ...
            <div className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-0.5">Xendit &amp; Transfer Manual</p>
                    </div>
                    {pendingCount > 0 && (
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-4 flex flex-wrap gap-3">
                    <input value={search} onChange={e => setSearch(e.target.value)}
                        ...
                        className="flex-1 min-w-[200px] border border-gray-200 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-[#E5654B] focus:border-[#E5654B]" />
                    <select value={status} onChange={e => { setStatus(e.target.value); applyFilter({ status: e.target.value }); }}
                        className="border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#E5654B]">
                    ...
                    <button onClick={() => applyFilter()}
                        className="px-5 py-2 bg-[#E5654B] text-white rounded-xl text-sm font-medium hover:bg-[#c94f3a]">Cari</button>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    {payments?.links?.length > 3 && (
                        <div className="px-4 py-3 border-t border-gray-100 flex gap-1">
