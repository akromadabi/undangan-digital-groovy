        ...
        <WizardLayout currentStep={step} title="Verifikasi Akun">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center max-w-md mx-auto">
                <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-5">
                    <ShieldCheck size={40} className="text-[#E5654B]" />
                </div>
                ...
                {isVerified ? (
                    <>
                        ...
                        <button
                            ...
                            disabled={processing}
                            className="w-full py-3 bg-gradient-to-r from-[#E5654B] to-[#c24b33] text-white rounded-xl font-semibold hover:shadow-lg transition-all"
                        >
                            Lanjutkan →
                        </button>
                    </>
                    ...
                    <>
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-[#E5654B] text-white rounded-xl font-medium hover:bg-[#c24b33] transition-colors"
                        >
