            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: 'Undangan Aktif', value: stats?.active_invitations || 0, gradient: 'from-purple-500 to-purple-600', icon: 'M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75' },
                        { label: 'Saldo Dompet', value: formatCurrency(reseller.reseller_wallet?.balance || 0), gradient: 'from-emerald-500 to-emerald-600', icon: 'M21 12a2 2 0 00-2-2H5a2 2 0 00-2 2v3a2 2 0 002 2h14a2 2 0 002-2v-3zM16 7a2 2 0 00-2-2H5a2 2 0 00-2 2v3a2 2 0 002 2h11a2 2 0 002-2V7z' },
