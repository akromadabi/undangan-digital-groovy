                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input type={showPassword ? "text" : "password"} value={pw.password} onChange={e => setPw({ ...pw, password: e.target.value })}
                                        className="w-full pl-4 pr-10 py-2.5 bg-white border border-[#e8e5e0] rounded-xl text-sm text-[#333] placeholder-[#bbb] focus:ring-2 focus:ring-[#E5654B]/30 focus:border-[#E5654B] outline-none" placeholder="Minimal 6 karakter" minLength={6} />
                                    <button
                                        type="button"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input type={showConfirmPassword ? "text" : "password"} value={pw.password_confirmation} onChange={e => setPw({ ...pw, password_confirmation: e.target.value })}
                                        className="w-full pl-4 pr-10 py-2.5 bg-white border border-[#e8e5e0] rounded-xl text-sm text-[#333] placeholder-[#bbb] focus:ring-2 focus:ring-[#E5654B]/30 focus:border-[#E5654B] outline-none" placeholder="Ulangi password" />
                                    <button
                                        type="button"
