                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link href={`/super-admin/impersonate/reseller/${r.id}`} method="post" as="button"
                                                    className="p-2 rounded-lg hover:bg-emerald-50 text-emerald-600 hover:text-emerald-700 transition-colors" title="Masuk sebagai Reseller (Impersonasi)">
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 rounded-lg hover:bg-red-50 text-[#999] hover:text-red-600 transition-colors"
                                                    title="Hapus"
                                                >
