...
export default function MonogramShield({ width = 134, height = 200, initials = 'TF', yearTop = '20', yearBottom = '26' }) {
    return (
        <div className="utary-cover__monogram" style={{ width, height }}>
            ...
            <div className="utary-cover__monogram-inner">
                ...
                <span className="utary-cover__monogram-initials">
                    {initials.charAt(0)}
                    {initials.length > 1 && <sub className="utary-cover__monogram-initial-sub">{initials.charAt(1)}</sub>}
                </span>
