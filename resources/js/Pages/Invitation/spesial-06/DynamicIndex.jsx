    ...
    return (
        <div className={`sp06-cover ${isOpened ? 'sp06-is-opened' : ''}`}>
            ...
            <div className="sp06-cover__content">
                ...
                <p className="text-xs font-semibold tracking-wider text-white/80 uppercase select-none font-serif leading-relaxed px-4">
            ...
            <Reveal variant="zoom" className="sp05-wellcome2-card">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <button 
                        type="button" 
                        onClick={() => {
                            const target = invitation?.countdown_target_date ? new Date(invitation.countdown_target_date) : new Date('2026-12-12T08:00:00');
