            ...
            {list.map((acc, idx) => {
                ...
                return (
                    <Reveal key={acc.id || idx} className="lx2-bank-card">
                        <img src={ASSETS.chip} alt="atm chip" className="lx2-bank-card__chip" />
                        <div className="lx2-bank-card__header">
                            <img src={logo} alt={acc.bank_name} className="lx2-bank-card__logo" />
                        </div>
                        <div className="lx2-bank-card__number">{acc.account_number}</div>
                        <div className="lx2-bank-card__holder-label">{invitation?.language === 'en' ? 'Account Holder:' : 'Pemilik Rekening:'}</div>
