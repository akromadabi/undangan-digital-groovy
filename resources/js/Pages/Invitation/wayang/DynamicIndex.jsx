                        ...
                        {ev.gmaps_link && (
                            <div className="wy-event-actions">
                                ...
                                {listEvents?.filter(ev => ev.show_dress_code).map((ev, idx) => (
                                    <div key={`dc-${idx}`} className="wy-event-card w-full mt-4" style={{ padding: '24px' }}>
                                        <DressCodeBlock event={ev} colors={{ primary: '#a3563f', text: '#1a1a1a' }} fonts={{ heading: 'inherit' }} variant="classic" plain={true} />
                                    </div>
                                ))}
