...
export function BaliAngkul({ className, width = 75, height = 75, color = 'var(--ab-secondary)', ...props }) {
    // Symmetrical Balinese Candi Bentar (Split Gateway) flanked by Tedung (ceremonial umbrellas)
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            ...
            <circle cx="60" cy="50" r="35" fill="var(--ab-accent)" opacity="0.1" />

            {/* Left Gate Pillar (Candi Bentar Left) */}
            <g>
                <path
                    d="M 52,90 L 32,90 C 30,90 28,88 28,86 L 28,82 C 28,82 31,82 31,80 L 29,80 C 27,80 26,78 26,76 L 26,72 C 26,70 28,68 30,68 L 30,64 C 30,64 34,64 34,60 L 32,60 C 31,60 30,58 30,56 L 30,52 C 30,50 32,48 34,48 L 34,44 L 33,44 L 33,36 C 33,34 35,32 37,32 L 37,28 L 36,28 L 36,18 C 36,16 38,14 40,14 L 40,8 L 44,8 L 44,14 C 46,14 48,16 48,18 L 48,28 L 50,28 C 51,28 52,30 52,32 L 52,90 Z"
                    fill={color}
                    stroke="var(--ab-primary)"
                    strokeWidth="1.2"
                    strokeLinejoin="round"
                />
                <path d="M 38,80 L 48,80 M 36,68 L 48,68 M 38,56 L 48,56 M 40,40 L 48,40 M 42,24 L 46,24" stroke="var(--ab-primary)" strokeWidth="1" />
                <rect x="42" y="83" width="4" height="4" fill="var(--ab-accent)" transform="rotate(45 44 85)" />
                <rect x="42" y="71" width="3" height="3" fill="var(--ab-accent)" transform="rotate(45 43.5 72.5)" />
                <rect x="42" y="59" width="3" height="3" fill="var(--ab-accent)" transform="rotate(45 44.5 60.5)" />
                <circle cx="45" cy="46" r="1.5" fill="var(--ab-accent)" />
                <circle cx="45" cy="34" r="1" fill="var(--ab-accent)" />
            </g>

            {/* Right Gate Pillar (Candi Bentar Right - Mirrored) */}
            ...
            {/* Threshold and Steps */}
            <rect x="48" y="86" width="24" height="4" fill="var(--ab-accent)" stroke="var(--ab-primary)" strokeWidth="1" />
            <rect x="52" y="82" width="16" height="4" fill="var(--ab-primary)" />
            
            {/* Left Tedung (Traditional Balinese Ceremonial Umbrella) */}
            <g transform="translate(14, 25)">
                <line x1="0" y1="0" x2="0" y2="65" stroke="var(--ab-primary)" strokeWidth="2.5" />
                <line x1="0" y1="10" x2="0" y2="50" stroke="white" strokeWidth="1" strokeDasharray="3,3" />
                <path d="M -12,18 C -12,18 -8,6 0,6 C 8,6 12,18 12,18 Z" fill="var(--ab-accent)" stroke="var(--ab-primary)" strokeWidth="1.2" />
                <path d="M -8,8 C -8,8 -5,0 0,0 C 5,0 8,8 8,8 Z" fill={color} stroke="var(--ab-primary)" strokeWidth="1.2" />
                <path d="M -1,-2 C -1,-5 1,-5 1,-2 L 0,-6 Z" fill={color} stroke="var(--ab-primary)" strokeWidth="0.8" />
                <path d="M -12,18 Q -10,24 -8,22" stroke="var(--ab-primary)" strokeWidth="1" fill="none" />
                <circle cx="-8" cy="22" r="1.2" fill={color} />
                <path d="M 12,18 Q 10,24 8,22" stroke="var(--ab-primary)" strokeWidth="1" fill="none" />
                <circle cx="8" cy="22" r="1.2" fill={color} />
                <path d="M 0,18 Q 0,26 2,24" stroke="var(--ab-primary)" strokeWidth="1" fill="none" />
                <circle cx="2" cy="24" r="1.2" fill={color} />
            </g>

            {/* Right Tedung (Traditional Balinese Ceremonial Umbrella) */}
            <g transform="translate(106, 25) scale(-1, 1)">
                <line x1="0" y1="0" x2="0" y2="65" stroke="var(--ab-primary)" strokeWidth="2.5" />
                <line x1="0" y1="10" x2="0" y2="50" stroke="white" strokeWidth="1" strokeDasharray="3,3" />
                <path d="M -12,18 C -12,18 -8,6 0,6 C 8,6 12,18 12,18 Z" fill="var(--ab-accent)" stroke="var(--ab-primary)" strokeWidth="1.2" />
                <path d="M -8,8 C -8,8 -5,0 0,0 C 5,0 8,8 8,8 Z" fill={color} stroke="var(--ab-primary)" strokeWidth="1.2" />
...
export function BaliKamboja({ className, width = 40, height = 40, color = 'var(--ab-secondary)', ...props }) {
    // Beautiful 5-petal Balinese Frangipani (Bunga Kamboja)
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            {/* Center Core */}
            <circle cx="25" cy="25" r="5" fill="#FFE15D" />
            
            {/* Petal 1 (Top) */}
            <path d="M 25,25 C 20,15 20,5 25,5 C 30,5 30,15 25,25 Z" fill="white" stroke={color} strokeWidth="1.5" />
            <path d="M 25,25 Q 23,12 25,8" stroke="#FFE15D" strokeWidth="2" strokeLinecap="round" />
            
            {/* Petal 2 (Top Right) */}
            <path d="M 25,25 C 33,18 43,20 44,25 C 45,30 35,32 25,25 Z" fill="white" stroke={color} strokeWidth="1.5" />
            <path d="M 25,25 Q 36,22 40,24" stroke="#FFE15D" strokeWidth="2" strokeLinecap="round" />
            
            {/* Petal 3 (Bottom Right) */}
            <path d="M 25,25 C 30,34 26,44 21,43 C 16,42 20,32 25,25 Z" fill="white" stroke={color} strokeWidth="1.5" />
            <path d="M 25,25 Q 27,36 24,40" stroke="#FFE15D" strokeWidth="2" strokeLinecap="round" />
            
            {/* Petal 4 (Bottom Left) */}
            <path d="M 25,25 C 16,33 6,29 5,24 C 4,19 14,18 25,25 Z" fill="white" stroke={color} strokeWidth="1.5" />
            <path d="M 25,25 Q 14,23 10,22" stroke="#FFE15D" strokeWidth="2" strokeLinecap="round" />
            
            {/* Petal 5 (Top Left) */}
            <path d="M 25,25 C 17,16 11,26 13,31 C 15,36 22,29 25,25 Z" fill="white" stroke={color} strokeWidth="1.5" />
            <path d="M 25,25 Q 18,29 15,32" stroke="#FFE15D" strokeWidth="2" strokeLinecap="round" />
            
            {/* Core Gem */}
            <circle cx="25" cy="25" r="2" fill="var(--ab-accent)" />
        </svg>
    );
}

export function BaliPatra({ className, width = 36, height = 36, color = 'var(--ab-secondary)', ...props }) {
    // Balinese Patra leaf scroll carving pattern
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            <path
                d="M 20,35 C 10,35 5,25 10,15 C 15,5 28,10 32,20 C 35,28 28,34 22,30 C 18,27 20,20 25,22 C 28,23 29,27 26,28 C 24,29 22,27 23,25"
                stroke={color}
                strokeWidth="2.5"
                strokeLinecap="round"
                fill="none"
            />
            <path d="M 10,23 Q 2,18 8,12" stroke="var(--ab-accent)" strokeWidth="1.5" fill="none" />
            <path d="M 24,11 Q 30,3 34,10" stroke="var(--ab-accent)" strokeWidth="1.5" fill="none" />
            <path d="M 33,23 Q 40,28 35,34" stroke="var(--ab-accent)" strokeWidth="1.5" fill="none" />
            <circle cx="25" cy="22" r="1.5" fill="var(--ab-primary)" />
        </svg>
    );
}

export function BaliKambojaCorner({ className, width = 80, height = 80, color = 'var(--ab-secondary)', flipped = false, ...props }) {
    // Beautiful corner ornament with kamboja flowers and patra leaves
    return (
        <svg
            width={width}
            height={height}
            ...
            {...props}
        >
            <path d="M 5,95 Q 5,20 80,20 Q 95,20 95,5" stroke={color} strokeWidth="3" fill="none" />
            <path d="M 5,95 Q 40,40 95,40" stroke="var(--ab-accent)" strokeWidth="2" fill="none" />
            ...
            <circle cx="85" cy="20" r="3" fill="var(--ab-accent)" />
            <circle cx="95" cy="40" r="2" fill="var(--ab-primary)" />
        </svg>
    );
}

export function BaliPatraDivider({ className, ...props }) {
    return (
        <div className={`flex items-center justify-center gap-4 py-6 ${className || ''}`} {...props}>
            <div className="h-[1px] flex-1 opacity-20" style={{ background: 'linear-gradient(to right, transparent, var(--ab-secondary))' }} />
            <BaliPatra width={28} height={28} />
            <BaliKamboja width={20} height={20} />
            <BaliPatra width={28} height={28} style={{ transform: 'scaleX(-1)' }} />
            <div className="h-[1px] flex-1 opacity-20" style={{ background: 'linear-gradient(to left, transparent, var(--ab-secondary))' }} />
        </div>
    );
}
...
function Reveal({ children, className = '', variant = 'up', delay = 0 }) {
    ...
    let baseClass = 'ab-reveal--up';
    if (variant === 'zoom') baseClass = 'ab-reveal--zoom';
    else if (variant === 'left') baseClass = 'ab-reveal--left';
    else if (variant === 'right') baseClass = 'ab-reveal--right';
    else if (variant === 'down') baseClass = 'ab-reveal--down';
...
function CoverSection({ invitation, brideGrooms, guest, isOpened, onOpen, themeConfig }) {
    ...
    return (
        <div className={`ab-cover${isOpened ? ' ab-slide--hidden' : ''}`}>
            {/* Majestic Cover background layer: full-screen photo slideshow if exists, otherwise centered Gunungan silhouette watermark */}
            {hasPhoto ? (
                <div className="ab-cover-bg-image absolute inset-0 w-full h-full overflow-hidden">
                    <PremiumSlideshow
                        images={coverImages}
                ...
                <div className="ab-cover-bg-image absolute inset-0 w-full h-full flex items-center justify-center overflow-hidden">
                    <BaliAngkul className="opacity-10 pointer-events-none z-0" width={280} height={392} />
                </div>
            )}
            
            <div className={`ab-cover-dark-overlay${hasPhoto ? ' hab-photo' : ''}`} />
            
            {/* Javanese wood-carving corner flourishes on top left and right */}
            <div className="ab-cover-lanterns-overlay" style={{ display: 'flex', justifyContent: 'space-between', padding: '0', width: '100%', position: 'absolute', top: 0, left: 0, zIndex: 10 }}>
                <BaliKambojaCorner className="ab-cover-lantern-left" style={{ width: '60px', height: 'auto' }} />
                <BaliKambojaCorner className="ab-cover-lantern-right" flipped style={{ width: '60px', height: 'auto' }} />
            </div>

            {/* Elegant outer gold border frame */}
            <div className="ab-cover-border-frame" />
            ...
            <div className="ab-cover-wrapper">
                ...
                <div className="ab-cover-kubah-icon-container" style={hasPhoto ? { marginBottom: '16px' } : undefined}>
                    <BaliAngkul className="ab-cover-kubah-icon" style={{ width: hasPhoto ? '80px' : '100px', height: 'auto', color: 'var(--ab-accent)', opacity: hasPhoto ? 0.9 : 1 }} />
                </div>

                {/* Text content blocks */}
                <div className="ab-cover-content-block">
                    <div className="ab-cover-badge">{themeConfig?.labels?.heroBadge || 'THE WEDDING OF'}</div>
                    <h1 className="ab-cover-couple">{coupleName}</h1>
                    
                    {invitation?.countdown_target_date && (
                        <div className="ab-cover-date">
                            {formatDate(invitation.countdown_target_date, invitation?.language)}
                        </div>
                    )}

                    <div className="ab-cover-dear-box">
                        <div className="ab-cover-dear">{isEn ? 'To:' : 'Kepada Yth:'}</div>
                        <div className="ab-cover-guest">{activeGuest.name}</div>
                        <p className="ab-cover-apology">{isEn ? '*We apologize for any spelling errors in names/titles' : '*Mohon maaf apabila terdapat kesalahan penulisan nama/gelar'}</p>
                    </div>

                    <button type="button" onClick={onOpen} id="tombol-buka" className="ab-btn-primary ab-btn-cover-buka">
...
function OpeningSection({ invitation, brideGrooms, language, themeConfig }) {
    ...
    return (
        <section id="opening" className="ab-opening-section-hero">
            {/* Subtle background texture */}
            <div className="ab-opening-bg-texture" />
            
            <div className="ab-opening-hero-block">
                {/* Top Javanese wood-carving flourishes decor */}
                <div className="ab-lantern-header-decor" style={{ display: 'flex', justifyContent: 'space-between', padding: '0', width: '100%', position: 'absolute', top: 0, left: 0, zIndex: 10 }}>
                    <BaliKambojaCorner className="ab-decor-lantern-left" style={{ width: '60px', height: 'auto' }} />
                    <BaliKambojaCorner className="ab-decor-lantern-right" flipped style={{ width: '60px', height: 'auto' }} />
                </div>

                <Reveal delay={100}>
                    <span className="ab-opening-hero-subtitle">
                ...
                {globalShowPhotos && openingImages.length > 0 ? (
                    <Reveal className="ab-opening-photo-window-container" variant="zoom" delay={200}>
                        <div className="ab-opening-photo-window">
                            <PremiumSlideshow
                                ...
                                imgClassName="absolute inset-0 w-full h-full object-cover"
                            />
                            <div className="ab-opening-photo-window-overlay" />
                        </div>
                        <BaliAngkul className="ab-opening-lantern-decor" style={{ width: '32px', height: 'auto', top: '-15px', color: 'var(--ab-accent)' }} />
                    </Reveal>
                ) : (
                    <Reveal className="ab-opening-photo-window-container" variant="zoom" delay={200}>
                        <div className="ab-opening-kubah-placeholder flex items-center justify-center">
                            <BaliAngkul style={{ width: '100px', height: 'auto', color: 'var(--ab-accent)' }} />
                        </div>
                    </Reveal>
                )}

                <Reveal delay={300}>
                    <h1 className="ab-opening-hero-couple">{coupleName}</h1>
                </Reveal>
                {formattedDate && (
                    <Reveal delay={500}>
                        <span className="ab-opening-hero-date">
                ...
                {/* Countdown Row */}
                {targetDate && (
                    <Reveal className="ab-opening-countdown-row" variant="zoom" delay={700}>
                        <div className="ab-opening-countdown-item">
                            <span className="ab-opening-countdown-value">{String(countdown.days).padStart(2, '0')}</span>
                            <span className="ab-opening-countdown-label">{language === 'en' ? 'Days' : 'Hari'}</span>
                        </div>
                        <div className="ab-opening-countdown-item">
                            <span className="ab-opening-countdown-value">{String(countdown.hours).padStart(2, '0')}</span>
                            <span className="ab-opening-countdown-label">{language === 'en' ? 'Hours' : 'Jam'}</span>
                        </div>
                        <div className="ab-opening-countdown-item">
                            <span className="ab-opening-countdown-value">{String(countdown.minutes).padStart(2, '0')}</span>
                            <span className="ab-opening-countdown-label">{language === 'en' ? 'Mins' : 'Menit'}</span>
                        </div>
                        <div className="ab-opening-countdown-item">
                            <span className="ab-opening-countdown-value">{String(countdown.seconds).padStart(2, '0')}</span>
                            <span className="ab-opening-countdown-label">{language === 'en' ? 'Secs' : 'Detik'}</span>
                        </div>
                    </Reveal>
                )}
            </div>

            <div className="ab-opening-content">
                {/* Javanese Gunungan Silhouette Divider */}
                <Reveal className="ab-opening-lantern-divider" variant="zoom">
                    <BaliAngkul className="mx-auto opacity-60" width={100} height={140} style={{ color: 'var(--ab-primary)' }} />
                </Reveal>

                {/* Text block with clean background and high contrast */}
                <Reveal className="ab-opening-text-block">
                    <h2 className="ab-opening-basmalah">{invitation?.religion === 'islam' ? 'Bismillahirrahmanirrahim' : (language === 'en' ? 'Welcome' : 'Selamat Datang')}</h2>
                    <div className="ab-opening-salut">
                ...
                {invitation?.opening_ayat && (
                    <Reveal className="ab-quote-box" variant="zoom" delay={200}>
                        <div className={`ab-quote-arabic${isArabicText(invitation.opening_ayat) ? ' is-arabic' : ''}`}>
                            {invitation.opening_ayat}
                        </div>
                        {invitation.opening_ayat_translation && 
                         invitation.opening_ayat_translation.trim() !== invitation.opening_ayat.trim() && (
                            <div className="ab-quote-translation">
                                "${invitation.opening_ayat_translation}"
                            </div>
                        )}
                        {invitation.opening_ayat_source && (
                            <div className="ab-quote-source">
                                — ${invitation.opening_ayat_source}
                            </div>
                        )}
                    </Reveal>
...
function CoupleSection({ brideGrooms, language, id, themeConfig }) {
    ...
    const renderMempelai = (m, genderLabel) => {
        ...
        return (
            <div className="ab-couple-card">
                
                
                {globalShowPhotos && m.photo ? (
                    <Reveal className="ab-profile-frame-wrap" variant="zoom">
                        <div className="ab-profile-arch-frame">
                            <img 
                                src={getThemeAssetUrl(m.photo, '')} 
                                className="ab-profile-photo" 
                                alt={m.full_name} 
                                style={{
                        ...
                        {m.gender === 'wanita' || String(m.gender).toLowerCase() === 'female' ? (
                            <BaliKamboja className="ab-profile-lantern-decor" style={{ width: '45px', height: 'auto', top: '-18px', color: 'var(--ab-secondary)' }} />
                        ) : (
                            <BaliAngkul className="ab-profile-lantern-decor" style={{ width: '32px', height: 'auto', top: '-15px', color: 'var(--ab-accent)' }} />
                        )}
                    </Reveal>
                ) : (
                    <Reveal className="ab-profile-frame-wrap" variant="zoom">
                        <div className="ab-profile-arch-frame ab-profile-monograb-frame">
                            <div className="ab-profile-monograb-initial">
                ...
                <Reveal variant="up" delay={100}>
                    <h3 className="ab-profile-name">{m.full_name}</h3>
                </Reveal>
                <Reveal variant="up" delay={200}>
                    <div className="ab-profile-child-order">
                        {translateChildOrder(m.child_order, m.gender, isEn)}
                    </div>
                </Reveal>
                <Reveal variant="up" delay={300}>
                    <div className="ab-profile-parents">
                        {!m.child_order && (
                            <>
                ...
                {(m.instagram || m.instagram_username) && (
                    <Reveal variant="zoom" delay={400}>
                        <a
                            ...
                            className="ab-profile-instagram"
                        >
    ...
    return (
        <section id={id || "couple"} className="ab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">{coupleSubtitle}</h4>
                <h2 className="ab-section-title">{coupleTitle}</h2>
            </Reveal>

            {isSingleHost ? (
                renderMempelai(couples[0] || {}, 'host')
            ) : (
                <div className="ab-couples-grid">
                    {renderMempelai(groom, 'groom')}
                    {groom.full_name && bride.full_name && (
                        <div className="ab-couple-ampersand">&amp;</div>
                    )}
...
function EventSection({ events, invitation, sections, language, themeConfig }) {
    ...
    return (
        <section id="event" className="ab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">{eventSubtitle}</h4>
                <h2 className="ab-section-title">{eventTitle}</h2>
            </Reveal>

            {/* Countdown widget */}
            {showCountdownInEvent && countdownTargetDate && (
                <Reveal className="ab-countdown-row" variant="zoom">
                    <div className="ab-countdown-item">
                        <span className="ab-countdown-value">{String(countdown.days).padStart(2, '0')}</span>
                        <span className="ab-countdown-label">{language === 'en' ? 'Days' : 'Hari'}</span>
                    </div>
                    <div className="ab-countdown-item">
                        <span className="ab-countdown-value">{String(countdown.hours).padStart(2, '0')}</span>
                        <span className="ab-countdown-label">{language === 'en' ? 'Hours' : 'Jam'}</span>
                    </div>
                    <div className="ab-countdown-item">
                        <span className="ab-countdown-value">{String(countdown.minutes).padStart(2, '0')}</span>
                        <span className="ab-countdown-label">{language === 'en' ? 'Mins' : 'Menit'}</span>
                    </div>
                    <div className="ab-countdown-item">
                        <span className="ab-countdown-value">{String(countdown.seconds).padStart(2, '0')}</span>
                        <span className="ab-countdown-label">{language === 'en' ? 'Secs' : 'Detik'}</span>
                    </div>
                </Reveal>
            )}

            {/* Events Cards */}
            <div className="ab-events-list">
                {listEvents.map((ev, idx) => {
                    return (
                        <Reveal className="ab-event-card" variant={idx % 2 === 0 ? 'left' : 'right'} key={idx}>
                            <div className="ab-event-card-topper">
                                <BaliPatra className="ab-event-card-lantern-topper" style={{ color: 'var(--ab-accent)' }} />
                            </div>
                            <div className="ab-event-card-header">
                                <div className="ab-event-name">{ev.event_name}</div>
                            </div>
                            
                            <div className="ab-event-date-box">
                                <div className="ab-event-date">{formatDate(ev.event_date, language)}</div>
                                <div className="ab-event-time">
                                    {ev.start_time} - {ev.end_time || 'Selesai'} {ev.timezone || 'WIB'}
                                </div>
                            </div>

                            <div className="ab-event-venue">{ev.venue_name}</div>
                            <p className="ab-event-address">{ev.venue_address}</p>

                            {ev.gmaps_link && (
                                <div className="ab-event-actions">
                                    <a href={ev.gmaps_link} target="_blank" rel="noopener noreferrer" className="ab-btn-secondary">
                                ...
                                {listEvents?.filter(ev => ev.show_dress_code).map((ev, idx) => (
                                    <div key={`dc-${idx}`} className="ab-event-card w-full mt-4" style={{ padding: '24px' }}>
...
function LiveStreamingSection({ events, invitation, language, themeConfig }) {
    ...
    return (
        <section id="livestreas" className="ab-section ab-livestreab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">{streamSubtitle}</h4>
                <h2 className="ab-section-title">{streamTitle}</h2>
            </Reveal>

            <Reveal className="ab-moroccan-arch-container">
                {/* Decorative Javanese Gunungan on top of the arch container */}
                <div className="ab-arch-topper">
                    <BaliAngkul className="ab-arch-topper-lantern" style={{ width: '40px', height: 'auto', color: 'var(--ab-accent)' }} />
                </div>
                <div className="ab-arch-inner-content">
                    <h3 className="ab-livestreab-date">
                        {formatDate(primaryEvent?.event_date, language)}
                    </h3>
                    <p className="ab-livestreab-time">
                        {primaryEvent?.start_time} - {primaryEvent?.end_time === '23:59:00' ? 'Selesai' : primaryEvent?.end_time} {primaryEvent?.timezone || 'WIB'}
                    </p>
                    <p className="ab-livestreab-text">
                        {streamDesc}
                    </p>
                    <div className="ab-livestreab-buttons">
...
function TimelineCard({ story, language }) {
    ...
    return (
        <div ref={ref} className={`ab-timeline-card ${isActive ? 'is-active' : ''}`}>
            <div className="ab-timeline-dot flex items-center justify-center">
                <BaliPatra className="ab-timeline-lantern-icon" style={{ width: '18px', height: 'auto' }} />
            </div>
            {story.story_date && (
                <div className="ab-timeline-date">{formatDate(story.story_date, language)}</div>
            )}
            <h3 className="ab-timeline-title">{story.title}</h3>
            {story.description && (
                <p className="ab-timeline-desc">{story.description}</p>
            )}
        </div>
    );
}
...
function LoveStorySection({ loveStories, language, themeConfig }) {
    ...
    return (
        <section id="love_story" className="ab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">{storySubtitle}</h4>
                <h2 className="ab-section-title">{storyTitle}</h2>
            </Reveal>
...
function GallerySection({ galleries, language }) {
    ...
    return (
        <section id="gallery" className="ab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">Momen Bahagia</h4>
                <h2 className="ab-section-title">{language === 'en' ? 'GALLERY' : 'GALERI FOTO'}</h2>
            </Reveal>
            ...
            <div className="ab-gallery-grid">
                {listGalleries.map((g, idx) => {
                    ...
                    return (
                        <Reveal className="ab-gallery-item" variant="zoom" delay={idx * 100} key={idx}>
                            <div className="ab-gallery-frame" onClick={() => openLightbox(idx)}>
                                <img src={finalImg} className="ab-gallery-photo" alt={g.caption || 'Galeri'} />
                                <div className="ab-gallery-hover-overlay">
            ...
            {/* Lightbox Modal */}
            {lightbox.open && (
                <div className="ab-lightbox" onClick={closeLightbox}>
                    <button type="button" className="ab-lightbox-close" onClick={closeLightbox}>&times;</button>
                    <button type="button" className="ab-lightbox-arrow ab-lightbox-arrow--left" onClick={prevImage}>
                        <i className="fas fa-chevron-left" />
                    </button>
                    
                    <div className="ab-lightbox-content" onClick={e => e.stopPropagation()}>
                        <img 
                        ...
                        {listGalleries[lightbox.index]?.caption && (
                            <p className="ab-lightbox-caption">{listGalleries[lightbox.index].caption}</p>
                        )}
                    </div>

                    <button type="button" className="ab-lightbox-arrow ab-lightbox-arrow--right" onClick={nextImage}>
...
function BankSection({ bankAccounts, language }) {
    ...
    return (
        <section id="bank" className="ab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">Kirim Kado</h4>
                <h2 className="ab-section-title">{language === 'en' ? 'DIGITAL ENVELOPE' : 'AMPLOP DIGITAL'}</h2>
            </Reveal>

            <Reveal className="ab-bank-desc-wrap">
                <p className="ab-bank-desc">
                    {language === 'en' 
            ...
            <div className="ab-bank-cards-list">
                {listAccounts.map((acc, idx) => {
                    ...
                    return (
                        <Reveal className="ab-credit-card" variant="zoom" delay={idx * 150} key={idx}>
                            <div className="ab-card-inner">
                                <div className="ab-card-shine" />
                                <div className="ab-card-header">
                                    <span className="ab-card-label">Digital Envelope</span>
                                    {isBca && <img src={ASSETS.bca} className="ab-card-bank-logo" alt="BCA" />}
                                    {isDana && <img src={ASSETS.dana} className="ab-card-bank-logo ab-card-bank-logo--dana" alt="DANA" />}
                                    {!isBca && !isDana && <span className="ab-card-bank-name">{acc.bank_name}</span>}
                                </div>

                                <div className="ab-card-chip-row">
                                    <img src={ASSETS.chip} className="ab-card-chip" alt="ATM Chip" />
                                </div>

                                <div className="ab-card-number">{acc.account_number}</div>

                                <div className="ab-card-footer">
                                    <div className="ab-card-holder">
                                        <span className="ab-holder-label">{language === 'en' ? 'ON BEHALF OF' : 'ATAS NAMA'}</span>
                                        <span className="ab-holder-name">{acc.account_name}</span>
                                    </div>
                                    <button 
                                        type="button" 
                                        onClick={() => handleCopy(acc.account_number, idx)}
                                        className="ab-card-btn-copy"
                                    >
                                        {copiedIdx === idx ? (
                                            <>
...
function UnifiedRsvpWishes({ invitation, wishes, guest, language, enableRsvp, enableWishes }) {
    ...
    return (
        <section id="rsvp" className="ab-section">
            <Reveal>
                <h4 className="ab-section-subtitle">{isEn ? 'Confirmation' : 'Konfirmasi Kehadiran'}</h4>
                <h2 className="ab-section-title">{sectionTitle}</h2>
            </Reveal>

            <Reveal className="ab-rsvp-box-container">
                <div className="ab-rsvp-box-topper">
                    <BaliPatra className="ab-rsvp-box-lantern-topper" style={{ color: 'var(--ab-accent)' }} />
                </div>
                <form onSubmit={handleSubmit} className="ab-rsvp-form">
                    {/* Name Input */}
                    <div className="ab-form-group">
                        <label className="ab-form-label" htmlFor="rsvp_name">{isEn ? 'Your Name' : 'Nama Lengkap'}</label>
                        <input
                            type="text"
                            id="rsvp_name"
                            value={sharedName}
                    ...
                    {enableRsvp && (
                        <div className="ab-form-group">
                            <label className="ab-form-label">{isEn ? 'Attendance status' : 'Konfirmasi Kehadiran'}</label>
                            <div className="ab-rsvp-buttons-row">
                                {['hadir', 'tidak_hadir', 'belum_pasti'].map(opt => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`ab-rsvp-btn-option ${active ? 'is-active' : ''}`}
                                        >
                    ...
                    {enableRsvp && attendance === 'hadir' && (
                        <Reveal className="ab-form-group" variant="down">
                            <label className="ab-form-label" htmlFor="number_of_guests">
                    ...
                    {enableWishes && (
                        <div className="ab-form-group">
                            <label className="ab-form-label" htmlFor="wish_message">{isEn ? 'Wishes & Prayers' : 'Pesan / Ucapan'}</label>
                            <WishesEmojiPicker
                                    value={message}
                                    onChange={setMessage}
                                ...
                                className="ab-form-input ab-form-input--textarea"
                                rows={4}
                                required={!enableRsvp}
                            />
                                </WishesEmojiPicker>
                    ...
                    <button type="submit" disabled={isSubmitting} className="ab-btn-primary ab-btn-full">
                        {isSubmitting ? (isEn ? 'Sending...' : 'Mengirim...') : (isEn ? 'Send' : 'Kirim')}
                    </button>

                    {success && (
                        <p style={{ color: 'var(--ab-accent)', marginTop: '8px', fontSize: '12px', textAlign: 'center', fontWeight: 'bold' }}>
            ...
            {enableWishes && recentWishes.length > 0 && (
                <div className="ab-wishes-list-container" style={{ marginTop: '24px' }}>
                    {recentWishes.map((w, idx) => (
                        <Reveal className="ab-wish-bubble" variant="up" delay={idx * 50} key={idx}>
                            <div className="ab-wish-header">
                                <span className="ab-wish-sender">{w.sender_name || w.name}</span>
                                {w.attendance && (
                                    <span style={{ fontSize: '10px', color: 'var(--ab-primary)', border: '1px solid var(--ab-primary)', padding: '2px 8px', borderRadius: '12px' }}>
                                        {w.attendance === 'hadir' ? (isEn ? 'Attending' : 'Hadir') : (isEn ? 'Absent' : 'Tidak Hadir')}
                                    </span>
                                )}
                            </div>
                            <p className="ab-wish-message">{w.message}</p>
                        </Reveal>
                    ))}
                </div>
            )}
...
function ClosingSection({ invitation, brideGrooms, language, themeConfig }) {
    ...
    return (
        <section id="closing" className="ab-section ab-closing-section">
            {/* Top decorative Gunungan */}
            <div className="ab-closing-lantern-top">
                <BaliKamboja className="ab-closing-lantern-img mx-auto" style={{ width: '80px', height: 'auto', color: 'var(--ab-secondary)' }} />
            </div>

            <div className="ab-closing-body">
                <Reveal className="ab-closing-text-block">
                    <h2 className="ab-closing-title">{invitation?.closing_title || 'THANK YOU'}</h2>
                    <p className="ab-closing-text">
                        {themeConfig?.labels?.closingQuote}
                    </p>
                </Reveal>

                <Reveal delay={200} className="ab-closing-signature">
                    <p className="ab-signature-label">{themeConfig?.labels?.signatureTitle || 'Kami yang berbahagia,'}</p>
                    <h3 className="ab-signature-couple">{coupleName}</h3>
                    
                    <div className="ab-signature-parents" style={{ fontSize: '12px', color: 'var(--ab-text-muted)', lineHeight: '1.8', marginBottom: '20px' }}>
                        {hasGroomParents && (
                            <div>
                                {isEn
                    ...
                    {invitation?.turut_mengundang_text && (
                        <div className="ab-signature-turut">
                            <span className="ab-turut-label">{themeConfig?.labels?.signatureFamilies || 'Keluarga Besar:'}</span>
                            <p className="ab-turut-text" style={{ whiteSpace: 'pre-line' }}>{invitation.turut_mengundang_text}</p>
                        </div>
                    )}
                </Reveal>
            </div>

            <Reveal className="ab-closing-watermark">
                <p>Made with ❤️ by {brandName}</p>
            </Reveal>

            <div className="ab-closing-lantern-decor">
                <BaliAngkul className="ab-decor-lantern-bottom mx-auto" style={{ width: '100px', height: 'auto', color: 'var(--ab-primary)' }} />
            </div>
        </section>
    );
}
...
function NavigationMenu({
    ...
    useEffect(() => {
        ...
        const activeEl = document.querySelector(`.ab-nav-menu button[data-id="${activeMenuId}"]`);
        if (activeEl) {
    ...
    return (
        <>
            {/* Dock Menu Bawah */}
            <div className="ab-nav-menu">
                <div className="ab-nav-menu__inner--row">
                    {menuItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`ab-nav-menu__item ${isActive ? 'active' : ''}`}
                                title={item.label}
                            >
                                <i className={item.icon} />
                                <span className="ab-nav-item-text">{item.label}</span>
                            </button>
                        );
                    })}
                </div>
            ...
            <div className="ab-floating-btns">
                {enableQr && guest && (
                    <button
                        type="button"
                        className="ab-floating-btn"
                ...
                <button
                    ...
                    style={isFullscreen ? { backgroundColor: 'var(--ab-accent, #E9C46A)', color: 'var(--ab-bg)' } : {}}
                ...
                {invitation?.enable_auto_scroll !== false && (
                    <button
                        ...
                        style={autoScrollEnabled ? { backgroundColor: 'var(--ab-accent, #E9C46A)', color: 'var(--ab-bg)' } : {}}
...
export default function DynamicIndex({ invitation, sections, brideGrooms, events, galleries, loveStories, bankAccounts, wishes, guest, isDemo = false }) {
    ...
    const handlePointerDown = (clientX, clientY, target) => {
        ...
        if (target && typeof target.closest === 'function') {
            const scrollable = target.closest('.ab-slide-container');
            if (scrollable) {
    ...
    const handlePointerUp = (clientX, clientY, target) => {
        ...
        if (layoutMode === 'slide-h') {
            ...
            if ((Math.abs(diffY) > Math.abs(diffX)) && (Math.abs(diffY) > threshold || isFastSwipe)) {
                const scrollable = target && typeof target.closest === 'function' ? target.closest('.ab-slide-container') : null;
                if (scrollable) {
    ...
    const handleWheel = (e) => {
        ...
        const target = e.target.closest('.ab-slide-container');
    ...
    useEffect(() => {
        ...
        if (isSlideMode) {
            timer = setInterval(() => {
                const activeEl = containerRef.current?.querySelector('.ab-slide-container.is-active');
                if (activeEl) {
    ...
    useEffect(() => {
        ...
        const handleUserInteraction = (e) => {
            if (
                ...
                e.target.closest('.ab-floating-btn') || 
                e.target.closest('.ab-nav-menu') || 
    ...
    return (
        <ErrorBoundary>
            ...
            <div className={`ab-page ${!globalShowPhotos ? 'ab-no-photo-mode' : ''} ${!globalShowAnimations ? 'ab-no-animations' : ''}`} ref={containerRef}>
                ...
                {isOpened && (
                    <div className="ab-container">
                        ...
                        <div className="ab-container-bg flex items-center justify-center overflow-hidden">
                            <BaliAngkul className="opacity-5 pointer-events-none fixed" style={{ width: '85%', height: 'auto', maxWidth: '400px', top: '15%', transform: 'translateY(-10%)' }} />
                        </div>
                        
                        {/* Section wrappers - unified layout modes */}
                        <div 
                            className={`${isSlideMode ? 'ab-main-slide' : 'ab-scroll-container'} ${layoutMode === 'slide-h' ? 'ab-main--slide-h' : ''} ${layoutMode === 'slide-v' ? 'ab-main--slide-v' : ''}`}
                            ...
                            <>
                                {activeSlideIdx > 0 && (
                                    <button 
                                        type="button"
                                        onClick={goPrev}
                                        className="ab-slider-arrow ab-slider-arrow--left"
                                ...
                                {activeSlideIdx < activeSectionsWithoutCover.length - 1 && (
                                    <button 
                                        type="button"
                                        onClick={goNext}
                                        className="ab-slider-arrow ab-slider-arrow--right"
                                        style={{ color: 'var(--ab-primary)' }}
                                    >
                                        <i className="fas fa-chevron-right" />
                                    </button>
                                )}
                                <div className="ab-slider-dots-row">
                                    {activeSectionsWithoutCover.map((_, i) => (
                                        <button 
                                            type="button"
                                            key={i} 
                                            onClick={() => setActiveSlideIdx(i)}
                                            className={`ab-slider-dot ${i === activeSlideIdx ? 'is-active' : ''}`}
                                        />
                                    ))}
                                </div>
                            </>
                        ...
                        {enableQr && showQr && guest && (
                            <div className="ab-qr-modal-overlay" onClick={() => setShowQr(false)}>
                                <div className="ab-qr-modal-body" onClick={e => e.stopPropagation()}>
                                    <h3 className="ab-qr-modal-title">QR CHECK-IN</h3>
                                    <p className="ab-qr-modal-subtitle">{guest.name}</p>
                                    <div className="ab-qr-modal-canvab-wrap">
                                        <img 
                                            ...
                                            alt="QR" 
                                            className="ab-qr-canvas" 
                                        />
                                    </div>
                                    <p className="ab-qr-modal-tip">Tunjukkan QR Code ini kepada petugas penerima tamu</p>
                                    <button type="button" className="ab-btn-primary" onClick={() => setShowQr(false)}>
                                        Tutup
                                    </button>
                                </div>
                            </div>
