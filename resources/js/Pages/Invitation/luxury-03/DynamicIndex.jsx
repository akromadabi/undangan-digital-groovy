...
function CoverSection({ invitation, brideGrooms, guest, isOpened, onOpen }) {
    ...
    return (
        <div className={`lx3-cover${isOpened ? ' is-opened' : ''}`}>
            <div className="lx3-cover__bg" style={{ backgroundImage: `url(${coverBg})` }} />
        ...
        <section id="love_story" className="lx3-section">
            ...
            <div className="lx3-story">
                {list.map((story, idx) => {
                    const isEven = idx % 2 === 0;
                    return (
                        <div key={story.id || idx} className={`lx3-story__node lx3-story__node--${isEven ? 'left' : 'right'}`}>
...
function RsvpSection({ invitation, guest }) {
    ...
    return (
        <div id="rsvp_container" className="lx3-card">
            ...
            {submitted ? (
                <div style={{ textAlign: 'center', padding: '20px 0' }}>
                    <i className="far fa-check-circle" style={{ fontSize: '40px', color: 'var(--lx3-gold)', marginBottom: '10px' }} />
...
function WishesSection({ invitation, wishes, guest }) {
    ...
    return (
        <div id="wishes_container" className="lx3-card" style={{ marginTop: '20px' }}>
            <h3 className="lx3-event-card__name" style={{ color: 'var(--lx3-gold)', fontSize: '18px', marginBottom: 15 }}>
...
function UnifiedRsvpWishes({ invitation, wishes, guest, enableRsvp, enableWishes }) {
    ...
    return (
        <section id="rsvp" className="lx3-section">
            <Reveal>
                <h2 className="lx3-section-title">{t('nav.rsvp')} &amp; {t('invitation.wishes_title')}</h2>
                <p className="lx3-section-subtitle">Konfirmasi Kehadiran &amp; Doa Restu</p>
            </Reveal>
...
function ClosingSection({ invitation, brideGrooms, galleries }) {
    ...
    return (
        <section id="closing" className="lx3-section lx3-closing" style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'relative', zIndex: 2 }}>
                <Reveal>
                    <h2 className="lx3-closing__title">{invitation?.closing_title || 'Terima Kasih'}</h2>
