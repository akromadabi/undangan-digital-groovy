...
/* ─── Vector Betawi SVG Components (Pure Vector, No Pixelation) ─── */
export function BetawiMonas({ className, width = 75, height = 75, color = 'var(--ae-secondary)', ...props }) {
    // Symmetrical National Monument (Monas) silhouette representing Jakarta/Betawi
    return (
        <svg
            width={width}
            height={height}
            ...
            {...props}
        >
            {/* Golden Flame of Independence */}
            <path d="M 48,15 Q 50,2 52,15 Q 55,10 50,25 Q 45,10 48,15 Z" fill="#F1C40F" stroke="#E74C3C" strokeWidth="1" />
            {/* Peak Needle */}
            <line x1="50" y1="25" x2="50" y2="50" stroke="var(--ae-primary)" strokeWidth="2.5" />
            {/* Platform (Cawan) */}
            <path d="M 42,50 L 58,50 L 56,58 L 44,58 Z" fill="var(--ae-primary)" stroke={color} strokeWidth="1" />
            {/* Main Body (Tugu) */}
            <line x1="46" y1="58" x2="46" y2="95" stroke="var(--ae-primary)" strokeWidth="2" />
            <line x1="54" y1="58" x2="54" y2="95" stroke="var(--ae-primary)" strokeWidth="2" />
            <rect x="47" y="58" width="6" height="37" fill="var(--ae-primary)" opacity="0.2" />
            {/* Lower Block (Cawan Bawah) */}
            <path d="M 30,95 L 70,95 L 75,105 L 25,105 Z" fill={color} stroke="var(--ae-primary)" strokeWidth="1.2" />
            {/* Base Foundation */}
            <rect x="15" y="105" width="70" height="8" fill="var(--ae-primary)" stroke={color} strokeWidth="1" />
        </svg>
    );
}

export function BetawiKembangKelapa({ className, width = 40, height = 40, color = 'var(--ae-secondary)', ...props }) {
    // Colorful Betawi Kembang Kelapa (Paper flower tassel)
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            {/* Central stick */}
            <path d="M 30,60 L 30,20" stroke={color} strokeWidth="2.5" strokeLinecap="round" />
            {/* Colorful branches and stars (Ceria: Kuning, Hijau, Merah, Biru) */}
            <path d="M 30,30 Q 15,20 5,25" stroke="#E74C3C" strokeWidth="1.5" fill="none" />
            <path d="M 30,30 Q 20,10 15,5" stroke="#27AE60" strokeWidth="1.5" fill="none" />
            <path d="M 30,30 Q 30,5 30,2" stroke="#F1C40F" strokeWidth="1.5" fill="none" />
            <path d="M 30,30 Q 40,10 45,5" stroke="#3498DB" strokeWidth="1.5" fill="none" />
            <path d="M 30,30 Q 45,20 55,25" stroke="#9B59B6" strokeWidth="1.5" fill="none" />
            {/* Small flower stars at tips */}
            <circle cx="5" cy="25" r="3.5" fill="#F1C40F" />
            <circle cx="15" cy="5" r="3.5" fill="#3498DB" />
            <circle cx="30" cy="2" r="3.5" fill="#E74C3C" />
            <circle cx="45" cy="5" r="3.5" fill="#27AE60" />
            <circle cx="55" cy="25" r="3.5" fill="#FF5733" />
        </svg>
    );
}

export function BetawiGigiBalangDivider({ className, width = 120, height = 30, color = 'var(--ae-secondary)', ...props }) {
    // Betawi Gigi Balang repeating pattern (triangles and dots)
    return (
        <svg
            width={width}
            height={height}
            ...
            {...props}
        >
            <path d="M 0,0 L 0,8 L 10,18 L 20,8 L 20,0 M 20,0 L 20,8 L 30,18 L 40,8 L 40,0 M 40,0 L 40,8 L 50,18 L 60,8 L 60,0 M 60,0 L 60,8 L 70,18 L 80,8 L 80,0 M 80,0 L 80,8 L 90,18 L 100,8 L 100,0 M 100,0 L 100,8 L 110,18 L 120,8 L 120,0" stroke={color} strokeWidth="1.5" fill="none" />
            <circle cx="10" cy="5" r="1.5" fill="var(--ae-primary)" />
            <circle cx="30" cy="5" r="1.5" fill="var(--ae-primary)" />
            <circle cx="50" cy="5" r="1.5" fill="var(--ae-primary)" />
            <circle cx="70" cy="5" r="1.5" fill="var(--ae-primary)" />
            <circle cx="90" cy="5" r="1.5" fill="var(--ae-primary)" />
            <circle cx="110" cy="5" r="1.5" fill="var(--ae-primary)" />
        </svg>
    );
}

export function BetawiKerancangCorner({ className, width = 60, height = 60, color = 'var(--ae-secondary)', flipped = false, style, ...props }) {
    // Kebaya Kerancang delicate lace corner flourish
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            {/* L-shaped lace frame */}
            <path d="M 5,55 L 5,5 L 55,5" stroke="var(--ae-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
            <path d="M 10,50 L 10,10 L 50,10" stroke={color} strokeWidth="1.2" strokeDasharray="3,3" fill="none" />
            {/* Lace floral details */}
            <circle cx="15" cy="15" r="5" stroke="var(--ae-accent)" strokeWidth="1" fill="none" />
            <path d="M 5,5 C 10,10 15,10 20,20 C 10,10 10,15 5,5" fill="var(--ae-secondary)" opacity="0.3" />
            <circle cx="30" cy="10" r="2.5" fill="var(--ae-primary)" />
            <circle cx="10" cy="30" r="2.5" fill="var(--ae-primary)" />
        </svg>
    );
}
...
function Reveal({ children, className = '', variant = 'up', delay = 0 }) {
    ...
    let baseClass = 'ae-reveal--up';
    if (variant === 'zoom') baseClass = 'ae-reveal--zoom';
    else if (variant === 'left') baseClass = 'ae-reveal--left';
    else if (variant === 'right') baseClass = 'ae-reveal--right';
    else if (variant === 'down') baseClass = 'ae-reveal--down';
...
function CoverSection({ invitation, brideGrooms, guest, isOpened, onOpen, themeConfig }) {
    ...
    return (
        <div className={`ae-cover${isOpened ? ' ae-slide--hidden' : ''}`}>
            {/* Majestic Cover background layer: full-screen photo slideshow if exists, otherwise centered Gunungan silhouette watermark */}
            {hasPhoto ? (
                <div className="ae-cover-bg-image absolute inset-0 w-full h-full overflow-hidden">
                    <PremiumSlideshow
                        images={coverImages}
                ...
                <div className="ae-cover-bg-image absolute inset-0 w-full h-full flex items-center justify-center overflow-hidden">
                    <BetawiMonas className="opacity-10 pointer-events-none z-0" width={280} height={392} />
                </div>
            )}
            
            <div className={`ae-cover-dark-overlay${hasPhoto ? ' hae-photo' : ''}`} />
            
            {/* Javanese wood-carving corner flourishes on top left and right */}
            <div className="ae-cover-lanterns-overlay" style={{ display: 'flex', justifyContent: 'space-between', padding: '0', width: '100%', position: 'absolute', top: 0, left: 0, zIndex: 10 }}>
                <BetawiKerancangCorner className="ae-cover-lantern-left" style={{ width: '60px', height: 'auto' }} />
                <BetawiKerancangCorner className="ae-cover-lantern-right" flipped style={{ width: '60px', height: 'auto' }} />
            </div>

            {/* Elegant outer gold border frame */}
            <div className="ae-cover-border-frame" />

            <div className="ae-cover-wrapper">
                {/* Javanese Gunungan logo header (Smaller badge if full background photo, larger monogram if no photo) */}
                <div className="ae-cover-kubah-icon-container" style={hasPhoto ? { marginBottom: '16px' } : undefined}>
                    <BetawiMonas className="ae-cover-kubah-icon" style={{ width: hasPhoto ? '80px' : '100px', height: 'auto', color: 'var(--ae-accent)', opacity: hasPhoto ? 0.9 : 1 }} />
                </div>

                {/* Text content blocks */}
                <div className="ae-cover-content-block">
                    <div className="ae-cover-badge">{themeConfig?.labels?.heroBadge || 'THE WEDDING OF'}</div>
                    <h1 className="ae-cover-couple">{coupleName}</h1>
                    
                    {invitation?.countdown_target_date && (
                        <div className="ae-cover-date">
                            {formatDate(invitation.countdown_target_date, invitation?.language)}
                        </div>
                    )}

                    <div className="ae-cover-dear-box">
                        <div className="ae-cover-dear">{isEn ? 'To:' : 'Kepada Yth:'}</div>
                        <div className="ae-cover-guest">{activeGuest.name}</div>
                        <p className="ae-cover-apology">{isEn ? '*We apologize for any spelling errors in names/titles' : '*Mohon maaf apabila terdapat kesalahan penulisan nama/gelar'}</p>
                    </div>

                    <button type="button" onClick={onOpen} id="tombol-buka" className="ae-btn-primary ae-btn-cover-buka">
...
function OpeningSection({ invitation, brideGrooms, language, themeConfig }) {
    ...
    return (
        <section id="opening" className="ae-opening-section-hero">
            {/* Subtle background texture */}
            <div className="ae-opening-bg-texture" />
            
            <div className="ae-opening-hero-block">
                {/* Top Javanese wood-carving flourishes decor */}
                <div className="ae-lantern-header-decor" style={{ display: 'flex', justifyContent: 'space-between', padding: '0', width: '100%', position: 'absolute', top: 0, left: 0, zIndex: 10 }}>
                    <BetawiKerancangCorner className="ae-decor-lantern-left" style={{ width: '60px', height: 'auto' }} />
                    <BetawiKerancangCorner className="ae-decor-lantern-right" flipped style={{ width: '60px', height: 'auto' }} />
                </div>

                <Reveal delay={100}>
                    <span className="ae-opening-hero-subtitle">
                ...
                {globalShowPhotos && openingImages.length > 0 ? (
                    <Reveal className="ae-opening-photo-window-container" variant="zoom" delay={200}>
                        <div className="ae-opening-photo-window">
                            <PremiumSlideshow
                                ...
                                imgClassName="absolute inset-0 w-full h-full object-cover"
                            />
                            <div className="ae-opening-photo-window-overlay" />
                        </div>
                        <BetawiMonas className="ae-opening-lantern-decor" style={{ width: '32px', height: 'auto', top: '-15px', color: 'var(--ae-accent)' }} />
                    </Reveal>
                ) : (
                    <Reveal className="ae-opening-photo-window-container" variant="zoom" delay={200}>
                        <div className="ae-opening-kubah-placeholder flex items-center justify-center">
                            <BetawiMonas style={{ width: '100px', height: 'auto', color: 'var(--ae-accent)' }} />
                        </div>
                    </Reveal>
                )}

                <Reveal delay={300}>
                    <h1 className="ae-opening-hero-couple">{coupleName}</h1>
                </Reveal>
                {formattedDate && (
                    <Reveal delay={500}>
                        <span className="ae-opening-hero-date">
                ...
                {/* Countdown Row */}
                {targetDate && (
                    <Reveal className="ae-opening-countdown-row" variant="zoom" delay={700}>
                        <div className="ae-opening-countdown-item">
                            <span className="ae-opening-countdown-value">{String(countdown.days).padStart(2, '0')}</span>
                            <span className="ae-opening-countdown-label">{language === 'en' ? 'Days' : 'Hari'}</span>
                        </div>
                        <div className="ae-opening-countdown-item">
                            <span className="ae-opening-countdown-value">{String(countdown.hours).padStart(2, '0')}</span>
                            <span className="ae-opening-countdown-label">{language === 'en' ? 'Hours' : 'Jam'}</span>
                        </div>
                        <div className="ae-opening-countdown-item">
                            <span className="ae-opening-countdown-value">{String(countdown.minutes).padStart(2, '0')}</span>
                            <span className="ae-opening-countdown-label">{language === 'en' ? 'Mins' : 'Menit'}</span>
                        </div>
                        <div className="ae-opening-countdown-item">
                            <span className="ae-opening-countdown-value">{String(countdown.seconds).padStart(2, '0')}</span>
                            <span className="ae-opening-countdown-label">{language === 'en' ? 'Secs' : 'Detik'}</span>
                        </div>
                    </Reveal>
                )}
            </div>

            <div className="ae-opening-content">
                {/* Javanese Gunungan Silhouette Divider */}
                <Reveal className="ae-opening-lantern-divider" variant="zoom">
                    <BetawiMonas className="mx-auto opacity-60" width={100} height={140} style={{ color: 'var(--ae-primary)' }} />
                </Reveal>

                {/* Text block with clean background and high contrast */}
                <Reveal className="ae-opening-text-block">
                    <h2 className="ae-opening-basmalah">{invitation?.religion === 'islam' ? 'Bismillahirrahmanirrahim' : (language === 'en' ? 'Welcome' : 'Selamat Datang')}</h2>
                    <div className="ae-opening-salut">
                ...
                {invitation?.opening_ayat && (
                    <Reveal className="ae-quote-box" variant="zoom" delay={200}>
                        <div className={`ae-quote-arabic${isArabicText(invitation.opening_ayat) ? ' is-arabic' : ''}`}>
                            {invitation.opening_ayat}
                        </div>
                        {invitation.opening_ayat_translation && 
                         invitation.opening_ayat_translation.trim() !== invitation.opening_ayat.trim() && (
                            <div className="ae-quote-translation">
                                "${invitation.opening_ayat_translation}"
                            </div>
                        )}
                        {invitation.opening_ayat_source && (
                            <div className="ae-quote-source">
                                — ${invitation.opening_ayat_source}
                            </div>
                        )}
                    </Reveal>
...
function CoupleSection({ brideGrooms, language, id, themeConfig }) {
    ...
    const renderMempelai = (m, genderLabel) => {
        ...
        return (
            <div className="ae-couple-card">
                
                
                {globalShowPhotos && m.photo ? (
                    <Reveal className="ae-profile-frame-wrap" variant="zoom">
                        <div className="ae-profile-arch-frame">
                            <img 
                                src={getThemeAssetUrl(m.photo, '')} 
                                className="ae-profile-photo" 
                                alt={m.full_name} 
                                style={{
                        ...
                        {m.gender === 'wanita' || String(m.gender).toLowerCase() === 'female' ? (
                            <BetawiKembangKelapa className="ae-profile-lantern-decor" style={{ width: '45px', height: 'auto', top: '-18px', color: 'var(--ae-secondary)' }} />
                        ) : (
                            <BetawiMonas className="ae-profile-lantern-decor" style={{ width: '32px', height: 'auto', top: '-15px', color: 'var(--ae-accent)' }} />
                        )}
                    </Reveal>
                ) : (
                    <Reveal className="ae-profile-frame-wrap" variant="zoom">
                        <div className="ae-profile-arch-frame ae-profile-monograe-frame">
                            <div className="ae-profile-monograe-initial">
                ...
                <Reveal variant="up" delay={100}>
                    <h3 className="ae-profile-name">{m.full_name}</h3>
                </Reveal>
                <Reveal variant="up" delay={200}>
                    <div className="ae-profile-child-order">
                        {translateChildOrder(m.child_order, m.gender, isEn)}
                    </div>
                </Reveal>
                <Reveal variant="up" delay={300}>
                    <div className="ae-profile-parents">
                        {!m.child_order && (
                            <>
                ...
                {(m.instagram || m.instagram_username) && (
                    <Reveal variant="zoom" delay={400}>
                        <a
                            ...
                            className="ae-profile-instagram"
                        >
    ...
    return (
        <section id={id || "couple"} className="ae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">{coupleSubtitle}</h4>
                <h2 className="ae-section-title">{coupleTitle}</h2>
            </Reveal>

            {isSingleHost ? (
                renderMempelai(couples[0] || {}, 'host')
            ) : (
                <div className="ae-couples-grid">
                    {renderMempelai(groom, 'groom')}
                    {groom.full_name && bride.full_name && (
                        <div className="ae-couple-ampersand">&amp;</div>
                    )}
...
function EventSection({ events, invitation, sections, language, themeConfig }) {
    ...
    return (
        <section id="event" className="ae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">{eventSubtitle}</h4>
                <h2 className="ae-section-title">{eventTitle}</h2>
            </Reveal>

            {/* Countdown widget */}
            {showCountdownInEvent && countdownTargetDate && (
                <Reveal className="ae-countdown-row" variant="zoom">
                    <div className="ae-countdown-item">
                        <span className="ae-countdown-value">{String(countdown.days).padStart(2, '0')}</span>
                        <span className="ae-countdown-label">{language === 'en' ? 'Days' : 'Hari'}</span>
                    </div>
                    <div className="ae-countdown-item">
                        <span className="ae-countdown-value">{String(countdown.hours).padStart(2, '0')}</span>
                        <span className="ae-countdown-label">{language === 'en' ? 'Hours' : 'Jam'}</span>
                    </div>
                    <div className="ae-countdown-item">
                        <span className="ae-countdown-value">{String(countdown.minutes).padStart(2, '0')}</span>
                        <span className="ae-countdown-label">{language === 'en' ? 'Mins' : 'Menit'}</span>
                    </div>
                    <div className="ae-countdown-item">
                        <span className="ae-countdown-value">{String(countdown.seconds).padStart(2, '0')}</span>
                        <span className="ae-countdown-label">{language === 'en' ? 'Secs' : 'Detik'}</span>
                    </div>
                </Reveal>
            )}

            {/* Events Cards */}
            <div className="ae-events-list">
                {listEvents.map((ev, idx) => {
                    return (
                        <Reveal className="ae-event-card" variant={idx % 2 === 0 ? 'left' : 'right'} key={idx}>
                            <div className="ae-event-card-topper">
                                <BetawiGigiBalangDivider className="ae-event-card-lantern-topper" style={{ color: 'var(--ae-accent)' }} />
                            </div>
                            <div className="ae-event-card-header">
                                <div className="ae-event-name">{ev.event_name}</div>
                            </div>
                            
                            <div className="ae-event-date-box">
                                <div className="ae-event-date">{formatDate(ev.event_date, language)}</div>
                                <div className="ae-event-time">
                                    {ev.start_time} - {ev.end_time || 'Selesai'} {ev.timezone || 'WIB'}
                                </div>
                            </div>

                            <div className="ae-event-venue">{ev.venue_name}</div>
                            <p className="ae-event-address">{ev.venue_address}</p>

                            {ev.gmaps_link && (
                                <div className="ae-event-actions">
                                    <a href={ev.gmaps_link} target="_blank" rel="noopener noreferrer" className="ae-btn-secondary">
                                ...
                                {listEvents?.filter(ev => ev.show_dress_code).map((ev, idx) => (
                                    <div key={`dc-${idx}`} className="ae-event-card w-full mt-4" style={{ padding: '24px' }}>
                                        <DressCodeBlock event={ev} colors={{ primary: 'var(--ae-secondary)', text: 'var(--ae-primary)' }} fonts={{ heading: 'inherit' }} variant="classic" plain={true} />
                                    </div>
                                ))}
...
function LiveStreamingSection({ events, invitation, language, themeConfig }) {
    ...
    return (
        <section id="livestreas" className="ae-section ae-livestreae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">{streamSubtitle}</h4>
                <h2 className="ae-section-title">{streamTitle}</h2>
            </Reveal>

            <Reveal className="ae-moroccan-arch-container">
                {/* Decorative Javanese Gunungan on top of the arch container */}
                <div className="ae-arch-topper">
                    <BetawiMonas className="ae-arch-topper-lantern" style={{ width: '40px', height: 'auto', color: 'var(--ae-accent)' }} />
                </div>
                <div className="ae-arch-inner-content">
                    <h3 className="ae-livestreae-date">
                        {formatDate(primaryEvent?.event_date, language)}
                    </h3>
                    <p className="ae-livestreae-time">
                        {primaryEvent?.start_time} - {primaryEvent?.end_time === '23:59:00' ? 'Selesai' : primaryEvent?.end_time} {primaryEvent?.timezone || 'WIB'}
                    </p>
                    <p className="ae-livestreae-text">
                        {streamDesc}
                    </p>
                    <div className="ae-livestreae-buttons">
...
function TimelineCard({ story, language }) {
    ...
    return (
        <div ref={ref} className={`ae-timeline-card ${isActive ? 'is-active' : ''}`}>
            <div className="ae-timeline-dot flex items-center justify-center">
                <BetawiGigiBalangDivider className="ae-timeline-lantern-icon" style={{ width: '18px', height: 'auto' }} />
            </div>
            {story.story_date && (
                <div className="ae-timeline-date">{formatDate(story.story_date, language)}</div>
            )}
            <h3 className="ae-timeline-title">{story.title}</h3>
            {story.description && (
                <p className="ae-timeline-desc">{story.description}</p>
            )}
        </div>
    );
}
...
function LoveStorySection({ loveStories, language, themeConfig }) {
    ...
    return (
        <section id="love_story" className="ae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">{storySubtitle}</h4>
                <h2 className="ae-section-title">{storyTitle}</h2>
            </Reveal>

            <div className="ae-timeline">
                <div className="ae-timeline-line" />
...
function GallerySection({ galleries, language }) {
    ...
    return (
        <section id="gallery" className="ae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">Momen Bahagia</h4>
                <h2 className="ae-section-title">{language === 'en' ? 'GALLERY' : 'GALERI FOTO'}</h2>
            </Reveal>
            ...
            <div className="ae-gallery-grid">
                {listGalleries.map((g, idx) => {
                    ...
                    return (
                        <Reveal className="ae-gallery-item" variant="zoom" delay={idx * 100} key={idx}>
                            <div className="ae-gallery-frame" onClick={() => openLightbox(idx)}>
                                <img src={finalImg} className="ae-gallery-photo" alt={g.caption || 'Galeri'} />
                                <div className="ae-gallery-hover-overlay">
            ...
            {/* Lightbox Modal */}
            {lightbox.open && (
                <div className="ae-lightbox" onClick={closeLightbox}>
                    <button type="button" className="ae-lightbox-close" onClick={closeLightbox}>&times;</button>
                    <button type="button" className="ae-lightbox-arrow ae-lightbox-arrow--left" onClick={prevImage}>
                        <i className="fas fa-chevron-left" />
                    </button>
                    
                    <div className="ae-lightbox-content" onClick={e => e.stopPropagation()}>
                        <img 
                            src={getThemeAssetUrl(listGalleries[lightbox.index]?.image_url, '')} 
                            className="ae-lightbox-img" 
                            alt="Lightbox" 
                        />
                        {listGalleries[lightbox.index]?.caption && (
                            <p className="ae-lightbox-caption">{listGalleries[lightbox.index].caption}</p>
                        )}
                    </div>

                    <button type="button" className="ae-lightbox-arrow ae-lightbox-arrow--right" onClick={nextImage}>
...
function BankSection({ bankAccounts, language }) {
    ...
    return (
        <section id="bank" className="ae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">Kirim Kado</h4>
                <h2 className="ae-section-title">{language === 'en' ? 'DIGITAL ENVELOPE' : 'AMPLOP DIGITAL'}</h2>
            </Reveal>

            <Reveal className="ae-bank-desc-wrap">
                <p className="ae-bank-desc">
                    {language === 'en' 
            ...
            <div className="ae-bank-cards-list">
                {listAccounts.map((acc, idx) => {
                    ...
                    return (
                        <Reveal className="ae-credit-card" variant="zoom" delay={idx * 150} key={idx}>
                            <div className="ae-card-inner">
                                <div className="ae-card-shine" />
                                <div className="ae-card-header">
                                    <span className="ae-card-label">Digital Envelope</span>
                                    {isBca && <img src={ASSETS.bca} className="ae-card-bank-logo" alt="BCA" />}
                                    {isDana && <img src={ASSETS.dana} className="ae-card-bank-logo ae-card-bank-logo--dana" alt="DANA" />}
                                    {!isBca && !isDana && <span className="ae-card-bank-name">{acc.bank_name}</span>}
                                </div>

                                <div className="ae-card-chip-row">
                                    <img src={ASSETS.chip} className="ae-card-chip" alt="ATM Chip" />
                                </div>

                                <div className="ae-card-number">{acc.account_number}</div>

                                <div className="ae-card-footer">
                                    <div className="ae-card-holder">
                                        <span className="ae-holder-label">{language === 'en' ? 'ON BEHALF OF' : 'ATAS NAMA'}</span>
                                        <span className="ae-holder-name">{acc.account_name}</span>
                                    </div>
                                    <button 
                                        type="button" 
                                        onClick={() => handleCopy(acc.account_number, idx)}
                                        className="ae-card-btn-copy"
                                    >
                                        {copiedIdx === idx ? (
                                            <>
...
function UnifiedRsvpWishes({ invitation, wishes, guest, language, enableRsvp, enableWishes }) {
    ...
    return (
        <section id="rsvp" className="ae-section">
            <Reveal>
                <h4 className="ae-section-subtitle">{isEn ? 'Confirmation' : 'Konfirmasi Kehadiran'}</h4>
                <h2 className="ae-section-title">{sectionTitle}</h2>
            </Reveal>

            <Reveal className="ae-rsvp-box-container">
                <div className="ae-rsvp-box-topper">
                    <BetawiGigiBalangDivider className="ae-rsvp-box-lantern-topper" style={{ color: 'var(--ae-accent)' }} />
                </div>
                <form onSubmit={handleSubmit} className="ae-rsvp-form">
                    {/* Name Input */}
                    <div className="ae-form-group">
                        <label className="ae-form-label" htmlFor="rsvp_name">{isEn ? 'Your Name' : 'Nama Lengkap'}</label>
                        <input
                            type="text"
                            id="rsvp_name"
                            value={sharedName}
                    ...
                    {enableRsvp && (
                        <div className="ae-form-group">
                            <label className="ae-form-label">{isEn ? 'Attendance status' : 'Konfirmasi Kehadiran'}</label>
                            <div className="ae-rsvp-buttons-row">
                                {['hadir', 'tidak_hadir', 'belum_pasti'].map(opt => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`ae-rsvp-btn-option ${active ? 'is-active' : ''}`}
                                        >
                    ...
                    {enableRsvp && attendance === 'hadir' && (
                        <Reveal className="ae-form-group" variant="down">
                            <label className="ae-form-label" htmlFor="number_of_guests">
                    ...
                    {enableWishes && (
                        <div className="ae-form-group">
                            <label className="ae-form-label" htmlFor="wish_message">{isEn ? 'Wishes & Prayers' : 'Pesan / Ucapan'}</label>
                            <WishesEmojiPicker
                                    value={message}
                                    onChange={setMessage}
                                ...
                                className="ae-form-input ae-form-input--textarea"
                                rows={4}
                                required={!enableRsvp}
                            />
                                </WishesEmojiPicker>
                    ...
                    <button type="submit" disabled={isSubmitting} className="ae-btn-primary ae-btn-full">
                        {isSubmitting ? (isEn ? 'Sending...' : 'Mengirim...') : (isEn ? 'Send' : 'Kirim')}
                    </button>

                    {success && (
                        <p style={{ color: 'var(--ae-accent)', marginTop: '8px', fontSize: '12px', textAlign: 'center', fontWeight: 'bold' }}>
            ...
            {enableWishes && recentWishes.length > 0 && (
                <div className="ae-wishes-list-container" style={{ marginTop: '24px' }}>
                    {recentWishes.map((w, idx) => (
                        <Reveal className="ae-wish-bubble" variant="up" delay={idx * 50} key={idx}>
                            <div className="ae-wish-header">
                                <span className="ae-wish-sender">{w.sender_name || w.name}</span>
                                {w.attendance && (
                                    <span style={{ fontSize: '10px', color: 'var(--ae-primary)', border: '1px solid var(--ae-primary)', padding: '2px 8px', borderRadius: '12px' }}>
                                        {w.attendance === 'hadir' ? (isEn ? 'Attending' : 'Hadir') : (isEn ? 'Absent' : 'Tidak Hadir')}
                                    </span>
                                )}
                            </div>
                            <p className="ae-wish-message">{w.message}</p>
                        </Reveal>
                    ))}
                </div>
            )}
...
function ClosingSection({ invitation, brideGrooms, language, themeConfig }) {
    ...
    return (
        <section id="closing" className="ae-section ae-closing-section">
            {/* Top decorative Gunungan */}
            <div className="ae-closing-lantern-top">
                <BetawiKembangKelapa className="ae-closing-lantern-img mx-auto" style={{ width: '80px', height: 'auto', color: 'var(--ae-secondary)' }} />
            </div>

            <div className="ae-closing-body">
                <Reveal className="ae-closing-text-block">
                    <h2 className="ae-closing-title">{invitation?.closing_title || 'THANK YOU'}</h2>
                    <p className="ae-closing-text">
                        {themeConfig?.labels?.closingQuote}
                    </p>
                </Reveal>

                <Reveal delay={200} className="ae-closing-signature">
                    <p className="ae-signature-label">{themeConfig?.labels?.signatureTitle || 'Kami yang berbahagia,'}</p>
                    <h3 className="ae-signature-couple">{coupleName}</h3>
                    
                    <div className="ae-signature-parents" style={{ fontSize: '12px', color: 'var(--ae-text-muted)', lineHeight: '1.8', marginBottom: '20px' }}>
                        {hasGroomParents && (
                            <div>
                                {isEn
                    ...
                    {invitation?.turut_mengundang_text && (
                        <div className="ae-signature-turut">
                            <span className="ae-turut-label">{themeConfig?.labels?.signatureFamilies || 'Keluarga Besar:'}</span>
                            <p className="ae-turut-text" style={{ whiteSpace: 'pre-line' }}>{invitation.turut_mengundang_text}</p>
                        </div>
                    )}
                </Reveal>
            </div>

            <Reveal className="ae-closing-watermark">
                <p>Made with ❤️ by {brandName}</p>
            </Reveal>

            <div className="ae-closing-lantern-decor">
                <BetawiMonas className="ae-decor-lantern-bottom mx-auto" style={{ width: '100px', height: 'auto', color: 'var(--ae-primary)' }} />
            </div>
        </section>
    );
}
...
function NavigationMenu({
    ...
    useEffect(() => {
        ...
        const activeEl = document.querySelector(`.ae-nav-menu button[data-id="${activeMenuId}"]`);
        if (activeEl) {
    ...
    return (
        <>
            {/* Dock Menu Bawah */}
            <div className="ae-nav-menu">
                <div className="ae-nav-menu__inner--row">
                    {menuItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`ae-nav-menu__item ${isActive ? 'active' : ''}`}
                                title={item.label}
                            >
                                <i className={item.icon} />
                                <span className="ae-nav-item-text">{item.label}</span>
                            </button>
                        );
                    })}
                </div>
            ...
            <div className="ae-floating-btns">
                {enableQr && guest && (
                    <button
                        type="button"
                        className="ae-floating-btn"
                ...
                <button
                    ...
                    style={isFullscreen ? { backgroundColor: 'var(--ae-accent, #E9C46A)', color: 'var(--ae-bg)' } : {}}
                ...
                {invitation?.enable_auto_scroll !== false && (
                    <button
                        ...
                        style={autoScrollEnabled ? { backgroundColor: 'var(--ae-accent, #E9C46A)', color: 'var(--ae-bg)' } : {}}
...
export default function DynamicIndex({ invitation, sections, brideGrooms, events, galleries, loveStories, bankAccounts, wishes, guest, isDemo = false }) {
    ...
    const handlePointerDown = (clientX, clientY, target) => {
        ...
        if (target && typeof target.closest === 'function') {
            const scrollable = target.closest('.ae-slide-container');
            if (scrollable) {
    ...
    const handlePointerUp = (clientX, clientY, target) => {
        ...
        if (layoutMode === 'slide-h') {
            ...
            if ((Math.abs(diffY) > Math.abs(diffX)) && (Math.abs(diffY) > threshold || isFastSwipe)) {
                const scrollable = target && typeof target.closest === 'function' ? target.closest('.ae-slide-container') : null;
                if (scrollable) {
    ...
    const handleWheel = (e) => {
        ...
        const target = e.target.closest('.ae-slide-container');
    ...
    useEffect(() => {
        ...
        if (isSlideMode) {
            timer = setInterval(() => {
                const activeEl = containerRef.current?.querySelector('.ae-slide-container.is-active');
                if (activeEl) {
    ...
    useEffect(() => {
        ...
        const handleUserInteraction = (e) => {
            if (
                ...
                e.target.closest('.ae-floating-btn') || 
                e.target.closest('.ae-nav-menu') || 
    ...
    return (
        <ErrorBoundary>
            ...
            <div className={`ae-page ${!globalShowPhotos ? 'ae-no-photo-mode' : ''} ${!globalShowAnimations ? 'ae-no-animations' : ''}`} ref={containerRef}>
                ...
                {isOpened && (
                    <div className="ae-container">
                        ...
                        <div className="ae-container-bg flex items-center justify-center overflow-hidden">
                            <BetawiMonas className="opacity-5 pointer-events-none fixed" style={{ width: '85%', height: 'auto', maxWidth: '400px', top: '15%', transform: 'translateY(-10%)' }} />
                        </div>
                        
                        {/* Section wrappers - unified layout modes */}
                        <div 
                            className={`${isSlideMode ? 'ae-main-slide' : 'ae-scroll-container'} ${layoutMode === 'slide-h' ? 'ae-main--slide-h' : ''} ${layoutMode === 'slide-v' ? 'ae-main--slide-v' : ''}`}
                            ...
                            <>
                                {activeSlideIdx > 0 && (
                                    <button 
                                        type="button"
                                        onClick={goPrev}
                                        className="ae-slider-arrow ae-slider-arrow--left"
                                        style={{ color: 'var(--ae-primary)' }}
                                    >
                                        <i className="fas fa-chevron-left" />
                                    </button>
                                )}
                                {activeSlideIdx < activeSectionsWithoutCover.length - 1 && (
                                    <button 
                                        type="button"
                                        onClick={goNext}
                                        className="ae-slider-arrow ae-slider-arrow--right"
                                        style={{ color: 'var(--ae-primary)' }}
                                    >
                                        <i className="fas fa-chevron-right" />
                                    </button>
                                )}
                                <div className="ae-slider-dots-row">
                                    {activeSectionsWithoutCover.map((_, i) => (
                                        <button 
                                            type="button"
                                            key={i} 
                                            onClick={() => setActiveSlideIdx(i)}
                                            className={`ae-slider-dot ${i === activeSlideIdx ? 'is-active' : ''}`}
                                        />
                                    ))}
                                </div>
                            </>
                        ...
                        {enableQr && showQr && guest && (
                            <div className="ae-qr-modal-overlay" onClick={() => setShowQr(false)}>
                                <div className="ae-qr-modal-body" onClick={e => e.stopPropagation()}>
                                    <h3 className="ae-qr-modal-title">QR CHECK-IN</h3>
                                    <p className="ae-qr-modal-subtitle">{guest.name}</p>
                                    <div className="ae-qr-modal-canvae-wrap">
                                        <img 
                                            ...
                                            alt="QR" 
                                            className="ae-qr-canvas" 
                                        />
                                    </div>
                                    <p className="ae-qr-modal-tip">Tunjukkan QR Code ini kepada petugas penerima tamu</p>
                                    <button type="button" className="ae-btn-primary" onClick={() => setShowQr(false)}>
                                        Tutup
                                    </button>
                                </div>
                            </div>
