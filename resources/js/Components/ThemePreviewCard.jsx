        ...
        if (template === 'single-phone') {
            return (
                <div className={`w-full h-full ${aspectClass} flex items-center justify-center p-3 sm:p-6 relative overflow-hidden`} style={{ perspective: '800px' }}>
                    ...
                    {renderGroundShadow('translate-y-[80%]', 'w-[60%] max-w-[160px]', 'opacity-65')}
                    
                    <div className="relative z-10 animate-in fade-in zoom-in duration-300 w-[76%] max-w-[200px]">
        ...
        if (template === 'double-phone') {
            return (
                <div className={`w-full h-full ${aspectClass} flex items-center justify-center relative overflow-hidden p-2 sm:p-4`} style={{ perspective: '800px' }}>
                    ...
                    {renderGroundShadow('-translate-x-[80%] translate-y-[60%] rotate-[-5deg]', 'w-[50%] max-w-[130px]', 'opacity-50')}
                    
                    {/* Right phone ground shadow */}
                    {renderGroundShadow('translate-x-[35%] translate-y-[80%] rotate-[4deg]', 'w-[52%] max-w-[135px]', 'opacity-60')}
                    
                    {/* Back Left Phone */}
                    <div className="absolute w-[62%] max-w-[170px] -translate-x-[35%] -translate-y-[12%] transform transition-transform duration-500 group-hover:-translate-x-[39%] z-10">
                        {renderPhone(images[1] || images[0], true, '', true, false)}
                    </div>
                    {/* Front Right Phone */}
                    <div className="absolute w-[62%] max-w-[170px] translate-x-[19%] translate-y-[12%] transform transition-transform duration-500 group-hover:translate-x-[23%] z-20">
        ...
        if (template === 'triple-phone') {
            return (
                <div className={`w-full h-full ${aspectClass} flex items-center justify-center relative overflow-hidden p-1 sm:p-2`} style={{ perspective: '800px' }}>
                    ...
                    {/* Left phone shadow */}
                    {renderGroundShadow('-translate-x-[140%] translate-y-[50%] rotate-[-8deg]', 'w-[40%] max-w-[110px]', 'opacity-40')}
                    
                    {/* Right phone shadow */}
                    {renderGroundShadow('translate-x-[50%] translate-y-[50%] rotate-[8deg]', 'w-[40%] max-w-[110px]', 'opacity-40')}
                    
                    {/* Center phone shadow */}
                    {renderGroundShadow('translate-y-[85%]', 'w-[44%] max-w-[125px]', 'opacity-65')}
                    
                    {/* Left Back Phone */}
                    <div className="absolute w-[50%] max-w-[140px] -translate-x-[45%] -translate-y-[15%] transform transition-transform duration-500 group-hover:-translate-x-[53%] z-10">
                        {renderPhone(images[1] || images[0], true, '', true, false)}
                    </div>
                    {/* Right Back Phone */}
                    <div className="absolute w-[50%] max-w-[140px] translate-x-[45%] -translate-y-[15%] transform transition-transform duration-500 group-hover:translate-x-[53%] z-10">
                    ...
                    {/* Center Front Phone */}
                    <div className="absolute w-[50%] max-w-[140px] translate-y-[8%] z-20 transform transition-transform duration-500 group-hover:scale-[1.03] group-hover:translate-y-[4%]">
