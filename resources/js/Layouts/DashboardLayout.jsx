...
const menuItems = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Filter Instagram', href: '/settings/instagram-filter', icon: 'M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316A2.192 2.192 0 0014.512 3.75H9.488c-.69 0-1.328.327-1.748.883l-.823 1.316zM12 9.75a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zm0 1.5a2.25 2.25 0 110 4.5 2.25 2.25 0 010-4.5z', feature: 'instagram_filter' },
            { label: 'Undangan AR', href: '/settings/ar', icon: 'M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12', feature: 'qr_code' },
        ],
    },
];
...
export default function DashboardLayout({ children, title }) {
    ...
    const isBottomActive = (item) => {
        ...
        if (item.href === '/theme?tab=pengaturan') {
            return currentPath === '/theme' && currentQuery.includes('tab=pengaturan');
        }
        if (item.href === '/theme') {
            return currentPath === '/theme' && !currentQuery.includes('tab=pengaturan');
        }
