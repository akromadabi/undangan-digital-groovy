...
const menuItems = [
    ...
    { label: 'Transaksi', href: '/admin/transactions', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
    ...
    { label: 'Kupon Diskon', href: '/admin/coupons', icon: 'M16.5 6v.75m0 3v.75m0 3v.75m-9-3h.008v.008H7.5V10.5zm3 0h.008v.008H10.5V10.5zm3 0h.008v.008H13.5V10.5zM3 9a2 2 0 012-2h14a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V9z' },
    {
        label: 'Pengaturan',
        href: '/admin/branding',
...
const menuSheetItems = [
    ...
    { label: 'Transaksi', href: '/admin/transactions', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', color: 'bg-emerald-50 text-emerald-600' },
    ...
    { label: 'Kupon Diskon', href: '/admin/coupons', icon: 'M16.5 6v.75m0 3v.75m0 3v.75m-9-3h.008v.008H7.5V10.5zm3 0h.008v.008H10.5V10.5zm3 0h.008v.008H13.5V10.5zM3 9a2 2 0 012-2h14a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V9z', color: 'bg-orange-50 text-orange-600' },
    { label: 'Dompet & Pencairan', href: '/admin/pencairan', icon: 'M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z', color: 'bg-teal-50 text-teal-600' },
