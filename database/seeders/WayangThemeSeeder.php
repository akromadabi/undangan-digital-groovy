...
class WayangThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                'name' => 'Tema Wayang',
                'thumbnail' => '/themes/wayang/thumbnail.webp',
                'preview_url' => '/themes/wayang/preview.webp',
                'category' => 'Premium',
                'color_scheme' => [
                    'primary' => '#D4B17F',
                    'secondary' => '#DDC068',
                ...
                'default_data' => [
                    ...
                    'bride_grooms' => [
                        [
                            ...
                            'gender' => 'pria',
                            'photo' => '/themes/wayang/asset/jawa-hitam-p-e1760493392899.jpg',
                            'bio' => '',
                            'instagram' => 'USERNAME',
                            'child_order' => 'Pertama',
                        ],
                        [
                            ...
                            'gender' => 'wanita',
                            'photo' => '/themes/wayang/asset/jawa-hitam-w.jpg',
                            'bio' => '',
                            'instagram' => 'USERNAME',
                            'child_order' => 'Kedua',
                        ],
                    ...
                    'love_stories' => [
                        ...
                        [
                            ...
                            'description' => 'Pada pertengahan tahun 2025, Bimo bersama keluarga besar secara resmi datang meminang Raras di hadapan kedua orang tuanya.',
                            'sort_order' => 2,
                        ],
                    ],
                    'events' => [
                    ...
                    'galleries' => [
                        ['image_url' => '/themes/wayang/asset/Mini-1-1-2-1024x683.jpg', 'caption' => '', 'sort_order' => 0],
                        ['image_url' => '/themes/wayang/asset/Mini-1-3-e1760494660200.jpg', 'caption' => '', 'sort_order' => 1],
                    ],
                    'bank_accounts' => [
                        [
                            'bank_name' => 'BCA',
