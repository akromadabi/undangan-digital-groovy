...
class ChelseaThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                'name' => 'ChelseaInVite',
                'thumbnail' => '/themes/chelsea/thumbnail.png',
                'preview_url' => '/themes/chelsea/preview.png',
                'category' => 'Premium',
                'color_scheme' => [
                    'primary' => '#034694',    // Chelsea Royal Blue
                    'secondary' => '#EE242C',  // Chelsea Red accent
                    'bg' => '#0A1B38',         // Deep Stamford Bridge Navy
                    'text' => '#FFFFFF',       // Text White
                    'accent' => '#122C5A',     // Dark Surface Panel Blue
                ],
                'font_config' => [
                    'heading' => 'Montserrat',
                ...
                'default_data' => [
                    'invitation' => [
                        ...
                        'closing_text' => 'Terima kasih atas kehadiran dan doa restu Anda di pertandingan bersejarah dalam hidup kami. Keep the Blue Flag Flying High, Bimo & Raras!',
                        'turut_mengundang_text' => '',
                        'religion' => 'islam',
                        'music_url' => '/audio/backsound.mp3',
                        'music_autoplay' => true,
                        'cover_title' => 'Bimo & Raras',
                        'cover_subtitle' => 'Kick-off of Our Love Journey • Stamford Bridge Stadium',
                    ...
                    'events' => [
                        ...
                        [
                            ...
                            'end_time' => '14:00',
                            'timezone' => 'WIB',
                            'venue_name' => 'Stamford Bridge Grand Hall',
                    ...
                    'wishes' => [
                        ['sender_name' => 'Ahmad Saputra', 'message' => 'Keep The Blue Flag Flying High Bimo & Raras! Selamat atas transfer terindah musim ini, semoga menjadi keluarga sakinah mawaddah wa rahmah! 💙⚽🏆'],
                    ],
                ],
            ]
        );
