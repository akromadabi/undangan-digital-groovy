...
class AdatMinangThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                'name' => 'Adat Minang',
                'thumbnail' => '/themes/adat-minang/thumbnail.webp',
                'preview_url' => '/themes/adat-minang/preview.webp',
                'category' => 'Premium',
                'color_scheme' => [
                    'primary' => '#C83E49', // Cheerful Vibrant Crimson Red
                    'secondary' => '#E3A824', // Vibrant Yellow Gold
                    'bg' => '#FCF8F2', // Bright Warm Cream Background
                    'text' => '#3E1C1F', // Deep Warm Chocolate Maroon (Highly readable on cream)
                    'accent' => '#D02A36', // Bright Accent Red
                ],
                'font_config' => [
                    'heading' => 'Cinzel',
                    'body' => 'Poppins',
                ...
                'css_file' => 'adat-minang/style.css',
