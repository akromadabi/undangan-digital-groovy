...
class SpotifyThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                ...
                'default_data' => [
                    'invitation' => [
                        'opening_title' => 'Now Playing: The Wedding',
                        ...
                        'cover_subtitle' => 'The Wedding Album of Bimo & Raras',
