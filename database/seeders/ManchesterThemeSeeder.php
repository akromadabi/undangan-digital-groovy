    ...
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                ...
                'default_data' => [
                    'invitation' => [
                        'opening_title' => 'WALIMATUL \'URSY',
                        'opening_text' => "Assalamu'alaikum Warahmatullahi Wabarakatuh\n\nDengan memohon rahmat dan ridho Allah SWT, kami mengundang Anda untuk menyaksikan permulaan babak baru kehidupan kami dalam ikatan suci pernikahan.",
                        ...
                        'closing_text' => 'Merupakan kehormatan bagi kami atas kehadiran dan doa restu Bapak/Ibu/Saudara/i sekalian di hari bahagia kami. Glory Glory Manchester United!',
                        'turut_mengundang_text' => '',
                        'religion' => 'islam',
                        'music_url' => '/audio/backsound.mp3',
                        'music_autoplay' => true,
                        'cover_title' => 'THE WEDDING OF',
                        'cover_subtitle' => 'Official invitation to our wedding celebration',
                    ...
                    'bride_grooms' => [
                        [
                            ...
                            'gender' => 'pria',
                            'photo' => '',
                            'bio' => 'Putra pertama yang siap membangun bahtera rumah tangga yang sakinah, mawaddah, warahmah.',
                            'instagram' => 'fletcher',
                            'child_order' => 'Pertama',
                        ],
                        [
                            ...
                            'gender' => 'wanita',
                            'photo' => '',
                            'bio' => 'Putri kedua yang siap mendampingi dengan ketulusan hati dan kasih sayang seumur hidup.',
                            'instagram' => 'beckham',
                            'child_order' => 'Kedua',
                        ],
                    ],
                    'love_stories' => [
                        [
                            ...
                            'description' => 'Pertama kali dipertemukan oleh takdir di Theatre of Dreams Yogyakarta. Awal kisah indah yang membawa kami ke arah yang sama.',
                            'sort_order' => 0,
                        ],
                        [
                            'title' => 'Membangun Komitmen',
                            'story_date' => '2024-11-20',
                            'description' => 'Setelah melewati berbagai perjalanan obrolan dan komitmen mendalam, kami memutuskan untuk mengakhiri masa pencarian dan masuk ke jenjang pernikahan yang suci.',
                            'sort_order' => 1,
                        ],
                    ],
                    'events' => [
