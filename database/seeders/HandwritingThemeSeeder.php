...
class HandwritingThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                'name' => 'Handwriting',
                'thumbnail' => '/themes/handwriting/thumbnail.png',
                'preview_url' => '/themes/handwriting/preview.png',
                'category' => 'Premium',
                'color_scheme' => [
                    'primary' => '#a68058',
                    'secondary' => '#8b6b4f',
                ...
                'css_file' => 'handwriting/style.css',
