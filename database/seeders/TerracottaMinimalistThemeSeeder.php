...
class TerracottaMinimalistThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ['slug' => 'terracotta-minimalist'],
            [
                'name' => 'Terracotta Minimalist',
                'thumbnail' => '/themes/terracotta-minimalist/thumbnail.png',
                'preview_url' => '/themes/terracotta-minimalist/preview.png',
                'category' => 'Premium',
                'color_scheme' => [
                    'primary' => '#b35c3c',
                    'secondary' => '#3d302a',
                ...
                'css_file' => 'terracotta-minimalist/style.css',
