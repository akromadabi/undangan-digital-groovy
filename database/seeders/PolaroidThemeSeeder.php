...
class PolaroidThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::updateOrCreate(
            ...
            [
                ...
                'thumbnail' => '/themes/polaroid-scrapbook/thumbnail.png',
                'preview_url' => '/themes/polaroid-scrapbook/preview.png',
                'category' => 'Premium',
                'color_scheme' => [
                    'primary' => '#b85c4c',
                    'secondary' => '#5c7a70',
                ...
                'css_file' => 'polaroid-scrapbook/style.css',
